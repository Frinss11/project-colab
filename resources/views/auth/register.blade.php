    ...
    <div class="bg-sky-100 flex justify-center items-center h-screen">
        ...
        <div class="w-1/2 h-screen hidden lg:block relative">
            <img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?q=80&w=1000&auto=format&fit=crop"
                alt="Ilustrasi Bank Soal & Edukasi" class="object-cover w-full h-full">
            ...
            <div class="absolute inset-0 flex flex-col justify-between p-12 text-white">
                ...
                <div>
                    <h2 class="text-4xl font-extrabold mb-3 leading-tight">MULAI BELAJAR & UJI KEMAMPUANMU</h2>
                    <p class="text-gray-100 text-lg max-w-lg">Buat akun siswa dan nikmati kemudahan mengakses berbagai
                        paket soal latihan ujian!</p>
                </div>
            </div>
        </div>
        ...
        <div class="lg:p-24 md:p-52 sm:p-20 p-8 w-full lg:w-1/2 flex flex-col justify-center">
            <h1 class="text-2xl font-semibold mb-1 text-gray-800">Daftar sebagai Siswa</h1>
            <p class="mb-4 text-sm text-gray-500">Akun guru dan admin dibuat oleh administrator.</p>

            <form action="{{ route('register') }}" method="POST">
                @csrf

                <div class="mb-4">
                    <label for="name" class="block text-gray-600 mb-1">Username / Nama</label>
                ...
                <button type="submit"
                    class="bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-md py-2 px-4 w-full transition duration-200">Register</button>
            </form>
            ...
            <div class="mt-2 text-center text-sm text-gray-600">
                Sudah Punya Akun? <a href="{{ route('login') }}"
                    class="text-green-500 font-medium hover:underline">Login</a>
            </div>
        </div>
    </div>
</x-guest-layout>
